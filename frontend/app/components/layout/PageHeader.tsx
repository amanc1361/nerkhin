    ...
    <section dir="rtl" className="relative isolate">
      ...
      <div className="mx-auto max-w-6xl px-4 py-8 md:py-10">
        ...
        <div className="text-center">
          <h1 className="text-xl md:text-2xl font-semibold text-slate-800 mb-2">{t.searchCta}</h1>
          <p className="text-slate-500 text-sm md:text-base">محصولات و برندها را سریع پیدا کنید</p>
        </div>
      </div>
    </section>
  );
