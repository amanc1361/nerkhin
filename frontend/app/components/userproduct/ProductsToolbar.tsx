...
export default function ProductsToolbar({
  ...
  return (
    <div dir="rtl" className="space-y-3">
      {/* ردیف: لیست قیمت / JPG / PDF / اشتراک (دقیقاً مثل عکس، از راست به چپ) */}
      <div className="flex flex-row-reverse items-center gap-2">
        <button
          type="button"
          className="flex items-center gap-1 rounded-xl bg-neutral-100 hover:bg-neutral-200 px-3 py-1.5 text-sm"
        ...
        <button
          type="button"
          onClick={share}
          className="ms-auto rounded-full p-2.5 bg-sky-50 hover:bg-sky-100 text-sky-700"
