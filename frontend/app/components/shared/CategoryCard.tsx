    ...
    <Link href={href} className="group block">
      {/* <div className="rounded-2xl p-2 border border-slate-200 bg-white shadow-sm hover:shadow-md transition"> */}
        <div className="aspect-square rounded-xl overflow-hidden bg-slate-100">
          {item.imageUrl ? (
            <Image src={"https://nerkhin.com/uploads/"+item.imageUrl} alt={item.title} width={300} height={300} className="object-cover w-full h-full group-hover:scale-[1.03] transition" />
