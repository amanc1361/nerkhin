...
export default function TopNav({
  ...
  const items: Array<{key: Active; href: string; label: string; icon: JSX.Element}> = [
  ...
  return (
    <div dir="rtl" className="sticky top-0 z-50">
      <div className="bg-white/70 backdrop-blur-md border-b border-slate-200/70">
        <div className="mx-auto max-w-6xl px-4 h-16 flex items-center justify-between">
          <div className="flex items-center gap-3">
            <Image src="/logo.svg" width={36} height={36} alt="logo" className="drop-shadow-sm" />
      ...
      {/* خط گرادیانی باریک زیر هدر برای حس کیفیت */}
